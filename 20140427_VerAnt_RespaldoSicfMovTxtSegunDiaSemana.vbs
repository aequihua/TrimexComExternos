...
'         \\sapdatamx\sapdata\interfaces\fi\archive\Lunes\SICF_MOV.LUN
'         \\sapdatamx\sapdata\interfaces\fi\archive\Lunes\SICF_MOV.MAr ==> etc.
'
...
ArchivoEnArchive  = "\\sapdatamx\sapdata\interfaces\fi\archive\SICF_MOV.txt"
RespaldoDomingo   = "\\sapdatamx\sapdata\interfaces\fi\archive\Domingo\SICF_MOV.Dom"
RespaldoLunes     = "\\sapdatamx\sapdata\interfaces\fi\archive\Lunes\SICF_MOV.Lun"
RespaldoMartes    = "\\sapdatamx\sapdata\interfaces\fi\archive\Martes\SICF_MOV.Mar"
RespaldoMiercoles = "\\sapdatamx\sapdata\interfaces\fi\archive\Miercoles\SICF_MOV.Mie"
RespaldoJueves    = "\\sapdatamx\sapdata\interfaces\fi\archive\Jueves\SICF_MOV.Jue"
RespaldoViernes   = "\\sapdatamx\sapdata\interfaces\fi\archive\Viernes\SICF_MOV.Vie"
RespaldoSabado    = "\\sapdatamx\sapdata\interfaces\fi\archive\Sabado\SICF_MOV.Sab"
...
'==========================================================================================================
'Espera 20 segundos a que se complete la acción de mover el archivo SICF_MOV.txt a \\sapdatamx\sapdata\interfaces\fi\archive

wscript.Sleep 20000

If Not objFSO1.FileExists(ArchivoEnArchive) Then
   strLog = "El archivo SICF_MOV.txt no fue copiado a \\sapdatamx\sapdata\interfaces\fi\archive en el servidor de MXP - favor revisar." & VbCrLf
   FncSendmail strMailAddressFrom, strMailADDressTo, "Job BI_TODASPTAS-CUBO-MENSUAL - Archivo SICF_MOV.txt no fue copiado a archive en MXP", strLog
   wscript.quit 
End If
...
If RespaldoDiariOK = "No" Then
   strLog = "Al parecer el archivo SICF_MOV.txt no pudo ser respaldado a la carpeta del día que corresponde bajo \\sapdatamx\sapdata\interfaces\fi\archive en el servidor de MXP - favor revisar que el archivo exista." & VbCrLf
   FncSendmail strMailAddressFrom, strMailADDressTo, "Job BI_TODASPTAS-CUBO-MENSUAL - Al parecer el archivo SICF_MOV.txt no pudo ser respaldado a la carpeta del día que corresponde en MXP", strLog
   wscript.quit
End If
